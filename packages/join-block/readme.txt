...
= 1.4.42 =
* Fix: hide duplicated radio input on payment plan page
= 1.4.41 =
...
= 1.4.35 =
* Remove lapsed/lapsing tags on successful join
= 1.4.34 =
* Add WordPress setting for log retention
= 1.4.33 =
* Add Loggly support
= 1.4.32 =
* Fix plugin dotenv loading
= 1.4.31 =
* Upgrade WordPress tested up to version
= 1.4.30 =
* Make log retention days an environment variable
= 1.4.29 =
...
= 1.4.25 =
* Add Require age 18 or older feature
= 1.4.24 =
...
= 1.4.22 =
* Don't update custom fields in Action Network if no changes detected
= 1.4.21 =
...
= 1.4.15 =
* Separate phone number country from address country
= 1.4.14 =
* Add international phone number validation
= 1.4.13 =
* Display "show details" button for full payment failure output, for debugging purposes
= 1.4.12 =
* Improve message shown to user on Stripe errors
= 1.4.11 =
* Allow fractional amounts for donations and custom payment plans
= 1.4.10 =
* Add option to make consent checkboxes required
= 1.4.9 =
* Self-heal stale membership plan slugs after v1.4.4 slug-format change
= 1.4.8 =
* Improve custom fields UX
= 1.4.7 =
* Improve conditiional custom fields admin ux
= 1.4.6 =
* Conditional custom fields
= 1.4.5 =
* Fix layout bug
* Add setting for consent checked by default
= 1.4.4 =
