interface StaticEnv {
    ...
    ENABLE_INTERNATIONAL_PHONE_NUMBERS: boolean;
    ...
    CURRENCY_SELECTION_COPY: string;
...
const staticEnv: StaticEnv = {
    ...
    ENABLE_INTERNATIONAL_PHONE_NUMBERS: parseBooleanEnvVar("REACT_APP_ENABLE_INTERNATIONAL_PHONE_NUMBERS"),
    ...
    CURRENCY_SELECTION_COPY: process.env.REACT_APP_CURRENCY_SELECTION_COPY || '',
    ...
    POSTCODE_ADDRESS_PROVIDER: process.env.REACT_APP_POSTCODE_ADDRESS_PROVIDER || '',
    ...
    REQUIRE_EMAIL_CONSENT: parseBooleanEnvVar("REACT_APP_REQUIRE_EMAIL_CONSENT"),
    REQUIRE_PHONE_CONSENT: parseBooleanEnvVar("REACT_APP_REQUIRE_PHONE_CONSENT"),
